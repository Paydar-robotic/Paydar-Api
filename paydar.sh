...
echo -e "$f2 Paydar Api By @PaydarTeam :)$rst"
echo ""
sleep 1
echo -e "\e[1mOperation : \e[96mStarting Bot\e[0m"
echo -e "\e[1mSource : \e[94m Paydar Api\e[0m"
echo -e "\e[38;5;82mDeveloper : \e[38;5;226mOmid Paydar @PaydarTeam\e[0m"
echo -e "\e[1m**********************************\e[0m"
sleep 2
...
sleep 0.5
echo -e "\e[1m#*#*#*#*#*#*#*#*#*#*#*#*#\e[0m"
echo -e "\e[92m     >>>> Paydar Api Launching <<<<\e[0m"
sleep 2
